                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ $paciente->id }}" data-toggle="modal" data-target="#delete_employee"><i class="fa fa-trash-o m-r-5"></i></a>
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="m-t-20"> 
                        ...
                        <form action="{{ route('paciente.destroy', $paciente->id) }}" method="post">
                            ...
                            <!-- <a href="http://"><button class="btn btn-danger submit-btn">Eliminar</button></a> -->
