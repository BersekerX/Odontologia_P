...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('css/clinic/img/favicon.ico') }}">
        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="{{asset('css/clinic/img/logo.png')}}" width="35" height="35" alt=""> <span>Preclinic</span>
				</a>
			</div>
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
											<span class="avatar">
												<img alt="John Doe" src="{{ asset('css/clinic/img/user.jpg')}}" class="img-fluid rounded-circle">
											</span>
